...
def non_mandatory_tour_frequency(persons, persons_merged,
    ...
    for segment_settings in spec_segments:
        ...
        estimator = \
            estimation.manager.begin_estimation(bundle_name='non_mandatory_tour_frequency', model_name=segment_name)
        ...
        if estimator:
            ...
            estimator.write_coefficients(coefficients_df, tag=coefficients_file_name)
